...
namespace Catalog.API.Data
{
    ...
    {
        public CatalogContext(IConfiguration configuartion)
        {
            ...
            Products = database.GetCollection<Product>(configuartion.GetValue<string>("DatabaseSettings:CollectionName"));
